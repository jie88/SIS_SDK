...
//            canvas.drawText("CCT(K)     " + Tool.df0.format(data.getDataFloatByDataType(Data.DataType_CCT)),
//                    PADDING_LEFT + 200, PADDING_TOP - 170, paint1);
//            canvas.drawText("Duv     " + Tool.df5.format(data.getDataFloatByDataType(Data.DataType_duv)),
//                    PADDING_LEFT + 200, PADDING_TOP - 120, paint1);
//            canvas.drawText("u＇     " + Tool.df4.format(data.getDataFloatByDataType(Data.DataType_u_)),
//                    PADDING_LEFT + 200, PADDING_TOP - 70, paint1);
//            canvas.drawText("v＇     " + Tool.df4.format(data.getDataFloatByDataType(Data.DataType_v_)),
...
//                fB[i] = MyApplication.spectrum_num[(MyApplication.spectrum_num.length - 1) /
//                        (fB.length - 1) * i];
//                if (fMax < fB[i]) {
//                    fMax = fB[i];
//                }
