...
/**
 * 类名: CcbPullToRefreshView <br/>
 * 功能描述: 自定义滑动加载. <br/>
 *  下拉刷新空间,上拉加载更多的控件,当成LinearLayout来使用
 *  @see
 */
public class SISPullToRefreshView extends LinearLayout {
	private static final String TAG = "CcbPullToRefreshView";
	// refresh states
	...
	private boolean enablePullTorefresh = false; //下拉刷新,默认关闭
	private boolean enablePullLoadMoreDataStatus = false;//加载更多,默认关闭
	/**
	 * last y
	 */
	...
	public SISPullToRefreshView(Context context, AttributeSet attrs) {
		super(context, attrs);
		init();
	}

	public SISPullToRefreshView(Context context) {
		super(context);
		init();
	}
	...
	private void addHeaderView() {
		...
		LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, mHeaderViewHeight);
	...
	private void addFooterView() {
		...
		LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, mFooterViewHeight);
		// int top = getHeight();
		// params.topMargin
	...
	public interface OnHeaderRefreshListener {
		public void onHeaderRefresh(SISPullToRefreshView view);
	}
